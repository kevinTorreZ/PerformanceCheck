...
from UserManagerAPI.views import UserViewSet,user_detail,LoginView,RegisterView,ObtenerEquipos,obtenerProyecto,obtenerTodosLosProyectos,ObtenerEquipo
...
urlpatterns = [
    ...
    path('api/equipo/',ObtenerEquipo.as_view()),
