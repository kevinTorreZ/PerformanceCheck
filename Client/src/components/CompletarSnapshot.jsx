            ...
            {step === 1 && (
                <div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button style={{ display: 'block', width: '100%', padding: '10px', backgroundColor: 'green', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer' }} type="submit" id='btnCompletar'>Completar Snapshot</button>
                        <button style={{ display: 'block', width: '100%', padding: '10px', backgroundColor: 'red', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer', marginTop: '10px' }} type="button" onClick={() => handleCancelarClick(false)} id='btnCancelar'>Cancelar</button>
                    </form>
                </div>
            )}
            {step === 2 && (
                <div>
                    <h1>¡Gracias por completar el Snapshot!</h1>
                    <button style={{ display: 'block', width: '100%', padding: '10px', backgroundColor: 'red', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer', marginTop: '10px' }} type="button" onClick={() => handleCancelarClick(false)} id='btnCancelar'>Volver</button>
                </div>                
            )}
        </div>
    );
